...
ALTER TABLE khachhang modify ngdk DATE;
ALTER TABLE khachhang modify ngsinh DATE;
ALTER TABLE nhanvien modify ngvl DATE;
...
INSERT INTO KHACHHANG (makh, hoten, dchi, sodt, ngsinh, doanhso, ngdk) VALUES ('KH01','NGUYEN VAN  A','731 TRAN HUNG DAO ,Q5,TPHCM','08823451','1960-10-22',13060000,'2006-06-22');
...
INSERT INTO KHACHHANG (makh, hoten, dchi, sodt, ngsinh, doanhso, ngdk) VALUES ('KH08','PHAN THI THANH','45/2 AN DUONG VUONG,Q5,TPHCM','093843756','1971/01/10',365000,'2006/12/13');
...
SELECT * FROM sanpham;
SELECT * FROM sanpham WHERE dvt = 'cay';
SELECT * FROM sanpham WHERE dvt = 'quyen';
SELECT masp, tensp FROM sanpham WHERE dvt = 'cay' OR dvt = 'quyen';

-- 3. In ra danh sách các sản phẩm (MASP,TENSP) có mã sản phẩm bắt đầu là “B” và kết thúc là “01”.
SELECT * FROM sanpham;
SELECT * FROM sanpham WHERE masp LIKE 'B%01';
